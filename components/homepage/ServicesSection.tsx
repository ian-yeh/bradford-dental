  ...
  return (
    <div>
      ...
      <div className="bg-white py-16 px-4 sm:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start w-[90%] md:w-[80%] max-w-[1200px] mx-auto">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 md:mt-16 w-[90%] md:w-[80%] max-w-[1200px] mx-auto">
          <div>
